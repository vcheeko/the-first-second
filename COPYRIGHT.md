...
All rights are reserved in the original copyrightable expression created for this project, including, where applicable, original human-authored text, narrative material, world-building, artwork, documentation, software code, audiovisual material, and other protectable creative expression.
...
Permission for reuse, licensing, collaboration, publication, adaptation, or commercial exploitation must be obtained from the rights holder in advance unless a later project file expressly grants such permission.

---

**Project:** THE FIRST SECOND  
**Repository:** `vcheeko/the-first-second`  
**Copyright notice established:** 2026
